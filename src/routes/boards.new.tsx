...
const templates = [
  { name: "Blank board", meta: "Start from scratch", featured: false },
  { name: "Feature launch", meta: "Product · 5 sections", featured: true },
  { name: "Pricing change", meta: "Revenue · 6 sections", featured: false },
  { name: "Deprecation", meta: "Lifecycle · 4 sections", featured: false },
];
        ...
        <div className="rounded-2xl border border-border bg-surface">
          ...
          <div className="space-y-8 p-6 md:p-8">
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <select className="mt-2 w-full rounded-md border border-input bg-background px-3 py-2.5 text-sm outline-none focus:border-accent focus:ring-2 focus:ring-accent/20">
                  <option>Maya Ramirez (you)</option>
                  <option>Jordan Klein</option>
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-border px-6 py-4 md:flex-row md:items-center md:justify-between md:px-8">
            ...
            <div className="flex gap-2">
              <button className="rounded-md border border-border bg-surface px-4 py-2 text-sm font-medium hover:bg-surface-muted">
                Save draft
              </button>
              <button
